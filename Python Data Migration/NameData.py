...
en_US_prefixes = ('Mr.', 'Mrs.', 'Ms.', 'Miss', 'Dr.')

en_US_suffixes = ('Jr.', 'Sr.', 'I', 'II', 'III', 'IV', 'V', 'MD', 'DDS', 'PhD', 'DVM')
...
es_MX_first_names = ('Abel', 'Abelardo', 'Abigail', 'Abraham', 'Abril',
...
es_MX_last_names = ( 'Abrego', 'Abreu', 'Acevedo', 'Acosta', 'Acuña',
...
es_MX_prefixes = ('Sr(a).', 'Dr.', 'Mtro.', 'Lic.' ,
    'Ing.'
)
...
cs_CZ_degrees = ('JUDr.', 'Ing.', 'Bc.', 'Mgr.', 'MUDr.', 'RNDr.' )

cs_CZ_prefixes_male = ('pan', ) + cs_CZ_degrees

cs_CZ_prefixes_female = ('paní', 'slečna', ) + cs_CZ_degrees

cs_CZ_suffixes = ('CSc.', 'DiS.', 'Ph.D.', 'Th.D.')
...
de_DE_prefixes_female = (
    'Frau', 'Dr.', 'Ing.', 'Dipl.-Ing.', 'Prof.', 'Univ.Prof.'
)

de_DE_suffixes = ('B.Sc.', 'B.A.', 'B.Eng.', 'MBA.')
...
el_GR_formats = el_GR_formats_male + el_GR_formats_female

el_GR_first_names_male = (
...
it_IT_prefixes = ('Sig.', 'Dott.', 'Sig.ra')
